...
function App() {
	...
	return (
		<div className="min-h-screen bg-gray-200">
			<div>
				<button
					className="accounts fixed z-50 h-16 w-16 transition ease-in rounded-full duration-300 bg-blue-900 hover:bg-blue-800 text-white"
					onClick={() => setModal(true)}
				>
					<UserIcon className="w-1/2 inline-block" />
				</button>
