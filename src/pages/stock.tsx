...
const Modal = ({ isOpen, closeModal, productName }) => {
  return (
    <Dialog
      ...
      visible={isOpen}
      onHide={closeModal}>
        <h2 className="font-bold mb-2 text-2xl sm:text-base min-w-full text-gray-600">Você está prestes a efetuar a compra de um <span className="text-black">{productName}</span>, escolha o tamanho disponível.</h2>
