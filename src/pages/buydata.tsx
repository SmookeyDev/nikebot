                ...
                <div className="p-10 rounded-md shadow-md bg-white">
                    ...
                    <div className="mb-6 flex flex-wrap -mx-3w-full">
                        ...
                        <div className="mb-6 w-2/4">
                            ...
                            <input
                                type="text" className="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest" disabled />
                        </div>
                    </div>
                    <div className="mb-6 flex flex-wrap -mx-3w-full">
                        <div className="w-full px-3">
                            ...
                            <div className="flex">
                                <select className="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest mr-6" disabled>
                                    <option>Mês</option>
                                </select>
                                <select className="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest" disabled>
                                    <option>Ano</option>
                                </select>
                            </div>
                        </div>
